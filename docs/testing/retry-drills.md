...
Workspace tests cover lost ref-CAS replies (C4, L2), concurrent same-id calls, intervening writes with a counted seek, expiry, complete-feed stable keys, group duplicates, and empty/oversized input.
